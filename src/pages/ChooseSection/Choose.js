            ...
            <div className="grid lg:grid-cols-3  grid-cols-1 gap-3 max-lg:text-center">
              {chooseData.map((item) => (
                <div className="ml-[28px] max-xxl:m-0">
                  <div>
                    <p className="font-[Gilroy-Bold] max-sm:text-start text-[24px] mb-[20px] leading-[28px] opacity-[0.9] max-md:text-center max-lg:text-center max-xs:text-[20px] max-xs:mb-[0.5rem]">
                      {item.name}
                    </p>
                  </div>
                  <div >
                    <p className="font-[Gilroy-Regular] max-sm:text-start text-[16px] mb-[14px] leading-[30px] opacity-[0.8] w-[284px] max-md:w-full max-lg:text-center max-lg:w-full max-xs:text-[12px]">
                      {item.detail}
                    </p>
                  </div>
                  <div className="flex max-lg:justify-center max-sm:justify-start ">
