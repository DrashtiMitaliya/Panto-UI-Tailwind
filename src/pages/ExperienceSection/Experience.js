...
import experienceImg from "../../Assets/images/experience_groupImage.svg";
import orangeAero from "../../Assets/images/orange_aero.svg";

const Experience = () => {
  return (
    <div className="mt-[240px]  max-xs:mt-[80px] max-sm:mt-[100px] max-md:mt-[120px] max-lg:mt-[160px] ">
      <div className="container-fluid">
        <div className="flex max-xl:flex-col">
          <div className="xl:w-1/2 w-full">
            <img src={experienceImg} alt="" className="max-w-full" />
          </div>
          <div className="xl:w-1/2 w-full mt-[83px] pr-[141px] max-xl:text-center max-xl:p-3 max-xxl:pl-[50px] max-xs:mt-[28px] max-sm:mt-[50px]  max-md:mt-[60px]  max-lg:mt-[70px]">
